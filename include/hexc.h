...
extern bool hex_state_win(uint16_t player_state[HEX_GSIZE]);
extern void hex_state_toggle(uint16_t player_state[HEX_GSIZE], uint8_t row, uint8_t col);
